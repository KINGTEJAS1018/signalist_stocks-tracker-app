   ...
   <main className="auth-layout">
    ...
    <section className="auth-right-section">
        ...
        <div className="flex-1 relative">
            <Image src="/assets/images/dashboard-preview.png" alt="Dashboard" width={1440} height={1150} className="auth-dashboard-preview absolute top-0" />
        </div>
